...
const closeModals = () => {
  ...
  setSelectedRow(null);
    ...
    const getStatusBadge = (status) => {
        ...
        switch (status) {
            case "For Approval":
                badgeColor = "bg-blue-400 text-sky-500 border-blue-600 hover:bg-blue-600 hover:text-white hover:border-blue-100";
                break;
            case "For Acknowledge":
                badgeColor = "bg-teal-400 text-teal-500 border-teal-600 hover:bg-teal-600 hover:text-white hover:border-teal-100";
                break;
            case "Completed":
                badgeColor = "bg-green-400 text-green-500 border-green-600 hover:bg-green-600 hover:text-white hover:border-green-100";
                break;
            case "Cancelled":
                badgeColor = "bg-red-400 text-red-500 border-red-600 hover:bg-red-600 hover:text-white hover:border-red-100";
                break;
        }
